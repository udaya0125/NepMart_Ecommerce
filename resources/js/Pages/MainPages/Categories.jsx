...
//         // Categories filter - send as comma separated
...
//         if (
//             filters.priceRange &&
//             (filters.priceRange[0] > productPriceRange.min ||
//                 filters.priceRange[1] < productPriceRange.max)
//         ) {
...
//         return params;
//     }, [filters, currentPage, productPriceRange, productsPerPage]);
...
//     // Filter products locally for immediate UI update (optional)
...
//                 discounted_price: parseFloat(product.discounted_price ?? product.price) || 0,
...
//                     // Add required fields for wishlist
//                     sku: product.sku || product.product_sku,
//                     brand: product.brand || product.product_brand,
//                 };
...
//             });
//         }
//     }, [filters, categories, allProducts]);
...
//                                         {filters.categories.length} category
//                                         selected
//                                     </div>
//                                 )}
//                             </div>
...
const Categories = () => {
    ...
    console.log("========================");
}, [filters, currentPage, allProducts.length, loading]);
